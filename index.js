...
const updateSignatureCount = () => {
  document.getElementById("counter").textContent = `🖊️ ${counter} people have signed this petition and support this cause.`;
};
...
const reduceMotion = (event) => {
  ...
  document.documentElement.style.setProperty('--transition-property', 'none');
  document.documentElement.style.setProperty('--transition-timing-function', 'none');
  reducedMotion.textContent = "Disabled Reduce Motion";
  }
  else {
    document.documentElement.style.setProperty('--transition-duration', '2s');
    document.documentElement.style.setProperty('--transition-delay', '0s');
    document.documentElement.style.setProperty('--transition-property', 'all');
    document.documentElement.style.setProperty('--transition-timing-function', 'ease');
